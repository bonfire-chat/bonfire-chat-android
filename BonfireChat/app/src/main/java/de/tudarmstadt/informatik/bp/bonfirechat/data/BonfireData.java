...
public class BonfireData extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db){
        ...
        db.execSQL("CREATE TABLE if not exists " + MESSAGES + "(uuid TEXT NOT NULL PRIMARY KEY, conversation INT NOT NULL, sender INT NOT NULL, messageDirection INTEGER NOT NULL, body TEXT, sentDate TEXT, insertDate INT) WITHOUT ROWID");
