 ...
 */
public class StatsCollector extends NonStopIntentService {
    ...
    /**
     * Creates the StatsCollector, called by Android creating the service
     */
    public StatsCollector() {
        super("BonFire_StatsCollector");
    }
    ...
    protected void onHandleIntent(Intent intent) {
        if (intent.getAction() == PUBLISH_STATS_ACTION) {
