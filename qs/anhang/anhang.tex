...
\includepdf[pages=1,scale=.8,pagecommand=\subsubsection{Initialer ``Android Lint''-Report}]{anhang/partials/lint-results.pdf}
\includepdf[pages=2-,scale=.8,pagecommand={}]{anhang/partials/lint-results.pdf}
